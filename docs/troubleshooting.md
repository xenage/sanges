...
On linux/x86_64, the bundled raw kernel currently needs more RAM than the tiny default. If the error mentions at least `3329 MiB`, set the BOX memory while it is still stopped:
