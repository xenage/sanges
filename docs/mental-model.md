...
If you understand these eight nouns, the rest of `sagens` gets much simpler.
...
- `image`: a named rootfs plus package cache used as the immutable base for new BOXes.
...
- Preinstall packages once: [Python quickstart named images](quickstart-python.md#named-images)
